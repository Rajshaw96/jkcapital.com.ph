...
@Component({
  selector: 'app-landing-loan-application-form',
  templateUrl: './landing-loan-application-form.component.html',
  styleUrls: ['./landing-loan-application-form.component.css']
})
export class LandingLoanApplicationFormComponent implements OnInit, OnDestroy {
