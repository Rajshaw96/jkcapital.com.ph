...
@Component({
  selector: 'app-jk-landing-loan-simulator',
  templateUrl: './jk-landing-loan-simulator.component.html',
  styleUrls: ['./jk-landing-loan-simulator.component.css']
})
export class JkLandingLoanSimulatorComponent implements OnInit {
